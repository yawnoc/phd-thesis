...
(see Figure~\ref{fig:bipolar-inner-candidate}).
...
A measure of the amount of asymmetry is obtained
by evaluating the ratio of distances from
the ideal centre~$v = +\infty$ (i.e.~$(x, y) = (+a, 0)$)
