...
\begin{figure}
  \newcommand*{\subfigurewidth}{0.47\textwidth}
  \includegraphics[trim=0 -5 0 0]{conformal_triangle-traced-boundaries-legend}
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent{conformal_triangle-traced-boundaries-zeta-space}{
      $\zeta$-space
    }
  \end{subfigure}
    \hfill
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent{conformal_triangle-traced-boundaries-z-space}{
      $z$-space
    }
  \end{subfigure}
  \caption{
