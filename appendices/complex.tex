...
Now, if~$z = z (\zeta)$ according to some conformal mapping,
then we have
\begin{important}{equation}
...
\end{enumerate}
The first two steps fix the known solution~$T (x, y) = \re \curlybr{W}$,
and in this regard
...
as per the general flux condition~(\ref{eq:flux-boundary-condition}).
...
\begin{figure}
  ...
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[
      trim=0 5 0 0,
    ]{conformal_triangle-grid-zeta-space}{$\zeta$-space}
  \end{subfigure}
    \hfill
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[
      trim=0 9 0 0,
    ]{conformal_triangle-grid-z-space}{$z$-space}
  \end{subfigure}
  \caption{
...
\begin{figure}
  \centredfigurecontent[width=0.48\textwidth]{%
    conformal_triangle-known-solution%
  }{
    Solution~(\ref{eq:conformal_triangle-known-solution}),
    mapped to~$zT$-space.
  }
\end{figure}
...
\begin{figure}
  \newcommand*{\subfigurewidth}{0.47\textwidth}
  \includegraphics[trim=0 -7 0 0]{conformal_triangle-traced-boundaries-legend}
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[
      trim=0 5 0 0,
    ]{conformal_triangle-traced-boundaries-zeta-space}{
      $\zeta$-space
    }
  \end{subfigure}
    \hfill
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[
      trim=0 9 0 0,
    ]{conformal_triangle-traced-boundaries-z-space}{
      $z$-space
    }
  \end{subfigure}
  \caption{
...
\begin{figure}
  \centredfigurecontent[width=0.44\textwidth]{%
    conformal_triangle-domain%
  }{
    A constructed domain
    with constant temperature
    along the internal triangular boundary~\figurestyle{dotted}
    and convection along the external boundary~\figurestyle{solid}.
  }
\end{figure}
