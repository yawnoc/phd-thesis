...
\begin{table}
  \centering
  \begin{tabular}{
    S[table-format=2, table-align-text-post=false]
    S
    ...
    \midrule
      ...
      55 \si{\degree}  &
        {finite}    &  1.5288  &
        1.97684     &  1.97583  &  -0.000509473 \\
      60 \si{\degree}  &
        {finite}    &  1.2548   &
        1.23778     &  1.2376   &  -0.000145694 \\
      65 \si{\degree}  &
        {finite}    &  1.0199   &
        0.872594    &  0.872555 &  -0.0000453895 \\
      70 \si{\degree}  &
        {finite}    &  0.8030   &
        0.628435    &  0.628421 &  -0.0000225007 \\
      75 \si{\degree}  &
        {finite}    &  0.5959   &
        0.439886    &  0.43988  &  -0.000012508 \\
      80 \si{\degree}  &
        {finite}    &  0.3946   &
        0.280581    &  0.280579 &  -7.90934e-6 \\
      85 \si{\degree}  &
        {finite}    &  0.1966   &
        0.136854    &  0.136853 &  -6.38643e-6 \\
    \bottomrule
  \end{tabular}
  \caption{
...
% TODO: remark about theoretical vs computed slopes
