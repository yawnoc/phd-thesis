...
Corner rounding for a numerical wedge solution was presented in Section~3.5
...
In that instance, the method was used
merely to evaluate the accuracy of asymptotically-determined corner roundings;
here the method is applied for its own sake.
