...
\begin{figure}
  ...
  \begin{minipage}[t]{0.5\textwidth}
    \centredfigurecontent[width=0.8\textwidth]{helmholtz-viable}{
      Non-viable domain~$\Phi < 0$.
    }
  \end{minipage}
  \begin{minipage}[t]{0.5\textwidth}
    \centredfigurecontent[width=0.8\textwidth]{helmholtz-traced-boundaries}{
...
\begin{figure}
  \centredfigurecontent[width=0.67\textwidth]{%
    helmholtz-height-rise-profiles%
  }{
    Height-rise profile along the original wedge walls
    and along the corner rounding
    of Figure~\ref{fig:helmholtz-traced-boundaries-hyperbolic-rounding},
...
\begin{figure}
  ...
  \centering
  \includegraphics[width=0.45\textwidth]{wedge_acute-traced-boundaries}
  \includegraphics[
    width=0.3\textwidth,
...
\begin{figure}
  ...
  \hspace*{\fill}
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[width=\textwidth, trim=0 -3 0 0]{%
      wedge_acute-traced-boundaries-different-angle-less%
    }{%
      $\tr{\gamma} = \SI{50}{\degree} < \gamma$
    }
  \end{subfigure}
    \hfill
  \begin{subfigure}[t]{\subfigurewidth}
...
\begin{figure}
  ...
  \begin{minipage}[t]{0.5\textwidth}
    \centredfigurecontent{wedge_acute-different-angle-offset-side}{%
      ...
      corresponding to~$\gamma$ and~$\tr{\gamma}$.
    }
  \end{minipage}
\end{figure}
...
\begin{figure}
  \centredfigurecontent[width=0.4\textwidth]{%
    wedge_acute-candidate-family%
  }{%
    One-parameter family of candidate boundaries for~$\tr{\gamma} \ge \gamma$,
    all obtained from the wedge solution
    for~$\alpha = \SI{40}{\degree}$ and~$\gamma = \SI{60}{\degree}$.
    From left to right:~$\tr{\gamma} = \SI{60}{\degree}, \SI{65}{\degree},
    \dots, \SI{85}{\degree}$.
  }
\end{figure}
...
(Figure~\ref{fig:wedge_acute-candidate-family}).
...
\begin{figure}
  \centredfigurecontent[width=0.4\textwidth]{%
    ...
    Candidate boundaries for~$\pi/2 - \alpha \le \gamma \le \tr{\gamma}$,
    all corresponding to the physically prescribed angles~%
    $\alpha = \SI{40}{\degree}$ and~$\tr{\gamma} = \SI{70}{\degree}$.
    From right to left:~%
...
(Figure~\ref{fig:wedge_acute-candidate-by-tracing-angle})
rather than~$\gamma$
(Figure~\ref{fig:wedge_acute-candidate-family}).
