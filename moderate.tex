...
\begin{figure}
  \newcommand*{\solutionfigurewidth}{8cm}
  \begin{minipage}[t]{0.95\textwidth - \solutionfigurewidth}
    \centredfigurecontent[width=0.8\textwidth]{helmholtz-wedge-domain}{
      Right-angled wedge domain.
    }
  \end{minipage}
  \hfill
  \begin{minipage}[t]{\solutionfigurewidth}
...
\begin{figure}
  \includegraphics[width=\textwidth]{helmholtz-legend}
  \begin{minipage}[t]{0.5\textwidth}
    \centredfigurecontent[width=0.9\textwidth]{helmholtz-viable}{
      Non-viable domain~$\Phi < 0$.
    }
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.5\textwidth}
    \centredfigurecontent[width=0.9\textwidth]{helmholtz-traced-boundaries}{
...
\begin{figure}
  ...
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent{helmholtz-traced-boundaries-hyperbolic-both}{%
      Two smooth boundaries
    }
  \end{subfigure}
    \hfill
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent{helmholtz-traced-boundaries-hyperbolic-rounding}{%
...
\begin{figure}
  ...
  \begin{subfigure}{0.53\textwidth}
    \centredfigurecontent{half_plane-mesh-halves}{%
      Full mesh
    }
  \end{subfigure}
    \hfill
  \begin{subfigure}{0.4\textwidth}
    \centredfigurecontent{half_plane-mesh-detail}{%
...
\begin{figure}
  \centredfigurecontent[width=0.6\textwidth]{%
    ...
    Relative error for the numerical half-plane solution,
    computed in the mesh with fine length scale~$\ell = 0.005$.
  }
\end{figure}
