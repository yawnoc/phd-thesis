...
as applicable to any orthogonal curvilinear coordinate system,
...
is rewritten as a first-order ODE (or system of ODEs)
...
\end{important}
where it is recalled that $T$~is a known solution
to the PDE under consideration
and $F$~is the prescribed flux function
on the right hand side of~(\ref{eq:flux-boundary-condition}).
Note that
