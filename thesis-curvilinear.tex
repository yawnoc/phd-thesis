...
\begin{align}
  \alpha &= \tder{\mu}{s} = \frac{\scalefac{u} \td u}{\td s},
...
so that
\begin{align}
  \tangentvec &= \alpha \basisvec{u} + \beta \basisvec{v},
    \label{eq:tangent-vector-abbreviated} \\
  \normalvec &= \beta \basisvec{u} - \alpha \basisvec{v}.
