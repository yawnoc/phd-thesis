...
\begin{figure}
  \centredfigurecontent[width=0.7\textwidth]{%
    line-traced-boundaries-hot-spikes%
  }{%
    Concave spike formed at~$r = 1$,
    on the outer viable island in the hot regime.
    The condition~(\ref{eq:line-traced-boundary-hot-convex-a-interval})
    only guarantees convexity at~$r = r_\sharp$~\figurestyle{dashed}.
  }
\end{figure}
...
to determine the precise radius at which the traced boundaries inflect
and become concave.
