...
It is appropriate here to restore all \scalingmarks;
...
In this chapter I have performed boundary tracing
...
I have shown that convex domains can only be constructed
in the subinterval~(\ref{eq:line-traced-boundary-hot-convex-a-interval})
of the hot regime;
the radiation boundaries are constructed by
...
Finally, I have determined the physical intervals
