...
In Cartesian coordinates the boundary curvature changes sign
in the same places as the second derivative,
...
\begin{equation}
  ...
  \label{eq:cosine-traced-boundary-curvature-cartesian-by-y-x-at-half-pi}
\end{equation}
