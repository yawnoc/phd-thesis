...
% * Mention critical terminal points along the y-axis, (0, \pm y_0)
\begin{enumerate}
  \item
  ...
  \item
    ...
    which one recalls is a terminal point
    isolated from the rest of the terminal curve,
    a peculiarity caused by the smaller non-viable region of the fair regime
  ...
  \item
    ...
    The terminal point~$(x_\flat, 0)$ lies in the unphysical region
