...
\begin{figure}[b]
  ...
  \newcommand*{\subfiguretrim}{5}
  \centering
  \begin{subfigure}{\subfigurewidth}
    \centredfigurecontent[
      trim=0 {\subfiguretrim} 0 0,
    ]{line-traced-boundaries-hot}{Hot regime}
  \end{subfigure}
  \hfill
  \begin{subfigure}{\subfigurewidth}
    \centredfigurecontent[
      trim=0 {\subfiguretrim} 0 0,
    ]{line-traced-boundaries-cold_hot}{Transition}
  \end{subfigure}
  \hfill
  \begin{subfigure}{\subfigurewidth}
    \centredfigurecontent[
      trim=0 {\subfiguretrim} 0 0,
    ]{line-traced-boundaries-cold}{Cold regime}
  \end{subfigure}
  \caption{
    Traced boundaries
...
or
\begin{figure}
  \centredfigurecontent[width=0.33\textwidth]{%
...
\begin{figure}
  \centredfigurecontent[width=0.95\textwidth]{%
    line-domains%
  }{
...
\begin{enumerate}[slightlytightlist, tightitems]
  \item
...
which restricts the possible values of the temperature
\begin{equation}
