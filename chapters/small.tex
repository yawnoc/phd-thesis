...
\begin{figure}
  ...
  \begin{minipage}[t]{0.25\textwidth}
    \centering
    \includegraphics[width=\textwidth, trim=0 {-0.27\textwidth} 0 0]{%
...
which is consistent with an elimination of the singularity at~$r = 0$.
...
\begin{figure}
  \centredfigurecontent[width=!, height=0.375\textwidth]{%
...
\begin{figure}
  ...
  \centering
  \includegraphics[width=0.45\textwidth, trim=0 5 0 0]{wedge_small-viable}
  \includegraphics[
    width=0.3\textwidth,
...
\begin{figure}
  ...
  \centering
  \includegraphics[width=0.45\textwidth, trim=0 8 0 0]{%
    wedge_small-traced-boundaries%
  }
  \includegraphics[
    width=0.3\textwidth,
    trim=0 {-\legendoffsetheight} 0 0,
...
\begin{figure}
  \newcommand*{\subfigurewidth}{0.43\textwidth}
...
(recall~(\ref{eq:moderate-offset-distance})
...
\begin{figure}
  ...
  \hfill
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[trim=0 6 0 0]{%
...
the comparison observation ($T_\modi \le T$) simply asserts that
a smooth boundary will produce a lower capillary rise
than a rough one.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centredfigurecontent[width=0.7\textwidth, trim=0 6 0 1]{%
