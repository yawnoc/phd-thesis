...
those solutions are only possible when the domain itself is asymmetric.
...
\end{equation}
asymptotes to the wedge walls as one travels away from the wedge corner.
...
to ensure that there is sufficient refinement in the grooves
