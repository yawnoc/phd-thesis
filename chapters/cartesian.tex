...
\begin{figure}
  ...
  \begin{subfigure}{\subfigurewidth}
    \centredfigurecontent[trim=0 {\subfiguretrim} 0 0]{%
      cosine_simple-self-viewing-bounds-none%
    }{
      $y < y_\view$
    }
  \end{subfigure}
  ...
  \begin{subfigure}{\subfigurewidth}
    \centredfigurecontent[trim=0 {\subfiguretrim} 0 0]{%
      cosine_simple-self-viewing-bounds-concave%
    }{
      $y_\view < y < y_\infl$
    }
  \end{subfigure}
  ...
  \begin{subfigure}{\subfigurewidth}
    \centredfigurecontent[trim=0 {\subfiguretrim} 0 0]{%
      cosine_simple-self-viewing-bounds-both%
    }{
      $y_\infl < y < y_\End$
    }
  \end{subfigure}
...
\end{equation}
Thus we extend the range of useful results
...
\begin{figure}
  ...
  \centering
  \includegraphics[width=0.45\textwidth, trim=0 6 0 4]{cosine_general-critical}
  \includegraphics[
    width=0.2\textwidth,
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth, trim=0 0 0 -4]{%
    cosine_general-physical-viable%
  }
  \includegraphics[width=\textwidth]{cosine_general-physical-viable-arrow}
  \includegraphics[width=\textwidth, trim=0 0 0 8]{%
    cosine_general-physical-viable-legend%
  }
  \caption{
...
these frontiers are the zero-contours of the second derivative~%
...
we discard any convex portion of traced boundary
which does not reach~$x = \pi/2$.
Of the remaining convex portions,
those which do not reach~$y = 0$ (the line of symmetry)
...
\begin{figure}
  \newcommand*{\meshoffsetheight}{0.11\textwidth}
  \centering
  \includegraphics[height=0.6\textwidth]{cosine-verification-lens-domain}
  \includegraphics[
    width=0.16\textwidth,
    trim=0 {-\meshoffsetheight} 0 0,
...
We can therefore be extremely confident
...
\begin{figure}
  ...
  \end{subfigure}
    \hfill
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[trim=0 4 0 0]{%
...
\begin{figure}
  ...
  \hspace*{\fill}
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[trim=0 9.5 0 0]{%
  ...
  \end{subfigure}
    \hfill
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[trim=0 10 0 0]{%
...
\pagebreak % (to fix wrong section in header of float-only page)
