...
\begin{figure}
  ...
  \caption{
    ...
    of a candidate domain boundary
    ...
    in~(\subref*{fig:cosine_simple-self-viewing-bounds-none}).
    Note the heavy exaggeration of shape.
  }
...
(\subref*{fig:cosine_simple-self-viewing-bounds-concave})~%
  from the concave portion, or
(\subref*{fig:cosine_simple-self-viewing-bounds-both})~%
  from both the concave and convex portions,
