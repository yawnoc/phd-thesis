...
as it is wide (in the $y$-direction).
Its half-width should therefore be roughly a tenth of its length.
Since
\[
...
and width
\begin{equation}
  W = (2 \scaled{y}_2) \lambda = 0.0187 \lambda.
  \label{eq:plane-fin-width}
\end{equation}
...
The unscaled heat flux (i.e.~power per unit area) is
\begin{equation}
  {-\conduc} \del T
...
\end{equation}
a constant vector.
Multiplying its magnitude by the fin width~$W = 2 \scaled{y}_2 \lambda$,
we obtain
\begin{equation}
...
\end{equation}
for the power dissipated in the negative $x$-direction
per unit length in the $z$-direction
(ignoring self-viewing radiation).
