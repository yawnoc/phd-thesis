...
\begin{figure}
  \newcommand*{\legendtrimwidth}{1.5cm}
  \centering
  \begin{minipage}{0.6\textwidth}
    \includegraphics[width=\textwidth]{cosine_simple-candidate-domains}
  \end{minipage}
  \begin{minipage}{0.4\textwidth-\legendtrimwidth}
    \includegraphics[
      width=\textwidth, trim={\legendtrimwidth} -50 0 0,
