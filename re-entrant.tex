...
and the psuedo-rounding is practically indistinguishable
...
and in this section we utlise a different approach
...
by a zigzag path of traced boundary portions
as shown in Figure~X. % TODO
...
with height~$\tr{h}$;
the finer the zigzags,
the closer the profile to being completely level.

Physically, the zigzag path with its small indentations
