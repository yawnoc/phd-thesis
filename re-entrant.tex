...
(qualitatively no different to the $\tr{\gamma} = \gamma$~case,
...
\begin{figure}
  ...
  \hspace*{\fill}
  \caption{
    Traced boundaries~\figurestyle{grey} for~$\tr{\gamma} > \gamma$.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{\subfigurewidth}
    \centredfigurecontent[width=!, height=\subfiguregraphicsheight]{%
      ...
      at the offset distance~$\xi = d (\gamma, \tr{\gamma})$
  ...
  \hspace*{\fill}
  \caption{
    Construction of a pseudo-rounding for~$\tr{\gamma} > \gamma$.
  }
...
\begin{figure}
  \centredfigurecontent[width=0.4\textwidth]{%
    ...
    One-parameter family of pseudo-roundings for~$\tr{\gamma} > \gamma$,
