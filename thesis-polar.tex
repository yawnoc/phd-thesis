...
\begin{align*}
  ...
  &= \frac{A^2 - r^2 \log^8 r}{A^2 r^2} \\[\tallspace]
...
the results of which are displayed in Figure~TODO.
...
Each protrusion is as follows (see Figure~TODO):
\begin{enumerate}
  \item
...
Figure~TODO{} shows the finite element meshes generated
for the two chosen cases:
the square-like domain of Figure~TODO{}
and the asymmetric domain of Figure~TODO.
...
and consist of around TODO~triangular elements.
...
The resulting numerical solutions are shown in Figure~TODO.
...
(Figure~TODO)
is no more than~TODO\% in both cases;
...
for PVC (taken from~(TODO: cite someone)),
