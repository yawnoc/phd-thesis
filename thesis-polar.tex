...
an analysis which I have allocated its own section:
...
caused instead by $\td^2 r / {\td\phi}^2$~being too large.
...
do indeed attach smoothly onto the boundary~$r = r_\sharp$ within finite time,
without forming a non-convex corner,
...
(at least at the point of tangency~$r = r_\sharp$)
is
\begin{equation}
