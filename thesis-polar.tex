...
To determine this radius,
I compute the curvature of the traced boundaries
as a function of~$r$.
...
\end{equation}
and the curvature of the curve~$\phi = \phi (r)$
will have the same sign as the quantity
given by the cross-product component
\begin{equation}
  \basisvec{z} \dotp \vec{r}' \crossp \vec{r}'' =
  r \phi'' + 2 \phi' + r^2 {\phi'}^3.
  \label{eq:curvature-polar-by-r}
\end{equation}
For brevity, this shall simply be referred to as curvature.
