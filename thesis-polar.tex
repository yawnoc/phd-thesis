...
\end{equation}
\strong{Dropping \scalingaccents}, the scaled boundary condition~%
...
\footnote{
  ...
  the terms \defin{upper} and \defin{lower}
...
It is appropriate here to \strong{restore all \scalingaccents};
