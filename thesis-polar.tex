...
along the sections which originate from the upper branch,
and strictly increasing along the sections from the lower branch.

Since $r (\phi)$~must be periodic,
the closed curve must therefore consist of both
upper-branch and lower-branch sections.
