...
% TODO list
% + Physical fin example
% + Update Cartesian Summary for Physical fin example
% + Change chosen endpoints for R (x_1, x_2) plot
%   to include the physical fin example
% + Use t instead of T for Celsius-temperature intervals
% + Corner lopping?
% ---
