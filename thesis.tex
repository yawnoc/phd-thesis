...
% Section numbering
% --------
% Use unstarred \chapter for frontmatter to appear in Table of contents.
%   Frontmatter: suppress numbering
%   Mainmatter: number down to subsubsections
% See <https://tex.stackexchange.com/a/43122>.
\let\barefrontmatter\frontmatter
\renewcommand*{\frontmatter}{
  \barefrontmatter
  \setcounter{secnumdepth}{-2}
}
\let\baremainmatter\mainmatter
...
\let\baretableofcontents\tableofcontents
...
% Tight lists
% --------
%   #1  [proportion] default "0.15"
\newcommand*{\tightlist}[1][0.15]{
...
% Real part
\newcommand*{\re}{\mathopspace\mathrm{Re}}
...
% + Coerce figures to be after all material from the previous section
%   e.g. by using [b]
% + Coerce figures to be on the same page turn if possible
%   i.e. [even-page | odd-page]
% + Coerce footnotes to be on the same page without overflow if possible
