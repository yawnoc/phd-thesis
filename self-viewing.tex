...
\begin{figure}
  ...
  \label{fig:self-viewing-radiation-elements-repeat}
\end{figure}
...
\begin{figure}
  ...
  \label{fig:self-viewing-radiation-elements-fin-repeat}
\end{figure}
...
\begin{equation}
  ...
  \label{eq:radiation-self-viewing-ratio-repeat}
\end{equation}
...
in the form of Figure~\ref{fig:self-viewing-radiation-elements-repeat}
and Figure~\ref{fig:self-viewing-radiation-elements-fin-repeat}.
...
Figure~\ref{fig:self-viewing-radiation-elements-repeat},
we have
\begin{align*}
...
\end{align*}
and from Figure~\ref{fig:self-viewing-radiation-elements-fin-repeat},
we see that
\begin{equation}
  \td A^\star
    = \td s^\star \td z^\star
...
the ratio~(\ref{eq:radiation-self-viewing-ratio-repeat}) becomes
\begin{equation}
  R =
    \frac{1}{T^4}
    \int_{-\infty}^{\infty}
