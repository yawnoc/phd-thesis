...
\footnote{
  For a comprehensive survey of capillary phenomena
  in zero or inverted gravity ($\densit \gravit / \surften \le 0$),
  see the many reviews of Finn~\cite{}
  or his book~\cite{finn-1986-equilibrium-capillary-surfaces}.
}
