...
but the accuracy of the asymptotic rounded corner
...
produced by \term{numerical boundary tracing},
...
to assess the accuracy of the asymptotic rounded corners.
Indeed numerical boundary tracing for its own sake
seems a pointless exercise;
instead of generating a rounded corner
...
and all of the capillary wedge cases (including the re-entrant case)
are considered.
