...
with the sole exception being the critical terminal point~$(x, y) = (x_0, 0)$
which lies at the intersection between
the terminal curve~(\ref{eq:small-terminal-curve})
and the line of symmetry~$y = 0$.
Preferring polar coordinates,
the critical terminal point is~$(r, \phi) = (r_0, 0)$,
where $r = r_0$~is the unique solution to
\begin{equation}
