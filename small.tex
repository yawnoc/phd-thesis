...
we need to compute first derivatives of the wedge solution~$T$.
Since it is~$H$ that has actually been computed,
we begin by expressing the relevant derivatives of~$T$ in terms of~$H$.
