...
has made a stronger and much more specific observation,
regarding whether the modification of a capillary wedge
will lower the height rise \emph{globally}.
This observation holds for any convex wedge (not just small),
...
The upshot is that near-corner modifications
(such as small-scale corner rounding)
will not only lower the height rise profile,
but will lower it to less than (or equal to)
the original wedge solution~$T$ evaluated along the modified boundary.
