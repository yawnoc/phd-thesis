...
\end{equation}
both in analytical investigations
and in numerical work.
...
and~(\ref{eq:radiation-boundary-condition}) tractable;
I have not yet come across any treatment of thermal radiation
in which the nonlinear term appears as a proper boundary term
in a flux condition such as~(\ref{eq:radiation-boundary-condition}),
rather than as a volumetric term in an ODE or PDE
