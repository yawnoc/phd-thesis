...
known as \defin{boundary tracing},
was carried out by
...
the theory of \defin{boundary tracing},
...
and $F$~is a given \defin{flux function}.
...
and seeks \defin{traced boundaries}, which are curves
...
\begin{figure}
  ...
  \caption{
    ...
    through a terminal point of the specified type,
    along with the non-viable domain (shaded).
  }
  \label{fig:terminal}
\end{figure}
...
\begin{itemize}
  \item
    the \defin{terminal curve},
    along which~$\norm{\del T} = \abs{F}$
    and traced boundaries are tangential to the local $T$-contour.
\end{itemize}
A point along the terminal curve is called a \defin{terminal point},
and is one of the following:
\begin{enumerate}
  \item
    An \defin{ordinary} terminal point
  ...
  \item
    ...
    \begin{enumerate}
      ...
      \item
        ...
        and is therefore called a \defin{critical terminal curve}.
...
the \stefanboltz{} constant~(TODO: cite NIST or similar).
