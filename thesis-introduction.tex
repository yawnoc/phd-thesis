...
\begin{figure}
  ...
  \end{subfigure}
  \caption{
    Terminal curve~\figurestyle{dashed},
    local $T$-contour~\figurestyle{dotted},
    and traced boundaries~\figurestyle{solid}
    through a terminal point.
    Also shown is the non-viable domain~\figurestyle{grey shaded}.
  }
  \label{fig:terminal}
\end{figure}
