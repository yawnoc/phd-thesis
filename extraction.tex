...
\begin{equation}
  \normalvec \ideq n_r \basisvec{r} + n_\phi \basisvec{\phi}.
...
\begin{equation}
  \mat{n} \dotp \squarebr[\bulkysize]{\mat{K} \matder H - \mat{v} H}
    = \cos\gamma.
  \label{eq:small-formally-rectangular-contact-boundary-condition-appendix}
\end{equation}
